...
I wrote pylons-common which houses much code that should not be generated by
a template. This needs to be installed. It is on github.


Installation and Setup
======================

Download + extract. Then run
